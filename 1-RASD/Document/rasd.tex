...
\item \itemtext{G3} {The user can search for a car in a certain location}
\item \itemtext{G4} {The user can search for a car in his current position}
