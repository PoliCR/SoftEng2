...
\end{enumerate}}{The user can enter and drive the car, starting by clicking "START" on the car display}{\begin{itemize}
...
\end{itemize}The system displays an error to and brings him back to the initial page.}
...
\usecasedesc{\textbf{Park the car}}{User, the system}{User must be logged in and must have taken a car}{\begin{enumerate}
		...
		\item The system locks the car.
\end{enumerate}}{User exits the car and pays the service(with an external system)}{\begin{itemize}
	\item The user can't afford the ride.
	\item The user doesn't click on the finish button on the car display.
\end{itemize}In both of these cases the external system payment is responsible.}
