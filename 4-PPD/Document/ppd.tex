...
\begin{tabularx}{\textwidth}{|X|X|X|}
	...
	\hline
	\hline
	Total & \multicolumn{1}{X}{} & \multicolumn{1}{X|}{39}\\
	\hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|}
	...
	\hline
	\hline
	Total & \multicolumn{1}{X}{} & \multicolumn{1}{X|}{22}\\
	\hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|}
	...
	\hline
	\hline
	Total & \multicolumn{1}{X}{} & \multicolumn{1}{X|}{36}\\
	\hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|}
	...
	\hline
	\hline
	Total & \multicolumn{1}{X}{} & \multicolumn{1}{X|}{2}\\
	\hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|}
	...
	\hline
	Internal Logic Files & ILFs & 39\\
	\hline
	External Logic Files & ELFs & 17\\
	\hline
	External Inputs & EIs & 22\\
	\hline
	External Inquiries & EQs & 36\\
	\hline
	External Outputs & EOs & 2\\
	\hline
	\hline
	Total & \multicolumn{1}{X}{} & \multicolumn{1}{X|}{116}\\
	\hline
\end{tabularx}
\\\\
...
\begin{tabularx}{\textwidth}{|X|X|}
	...
	\hline
	\textit{$116\times$46} & \textit{$116\times$67}\\
	\hline
	\textbf{5336} & \textbf{7772}\\
	\hline
\end{tabularx}
\newpage
