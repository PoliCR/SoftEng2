...
\begin{tabularx}{\textwidth}{|X|X|X|}
	\hline
	\textit{EOs} & \textit{Complexity} & \textit{Low}\\
	\hline
	Payment Notification & Low & 2\\
	\hline
	\hline
	Total & \multicolumn{2}{X|}{2}\\
	\hline
\end{tabularx}
